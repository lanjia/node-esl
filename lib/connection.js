...
class Connection extends _events.EventEmitter {
  ...
  connected() {
    return !_classPrivateFieldGet(this, _connecting) && !!_classPrivateFieldGet(this, _socket);
  }
  ...
  send(command, args) {
    _classPrivateFieldGet(this, _socket).write(this._toCommandString(command, args));
  }
  ...
  async subscribe(events, type = 'json') {
    const res = await this.events(type, events !== null && events !== void 0 ? events : ['all']);
    return res;
  }
